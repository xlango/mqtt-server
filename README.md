...
## Roadmap
- Please [open an issue](https://github.com/xlango/mqtt-server/issues) to request new features or event hooks!
- Cluster support.
...
Many of the internal server functions are now exposed to developers, so you can make your own Hooks by using the above as examples. If you do, please [Open an issue](https://github.com/xlango/mqtt-server/issues) and let everyone know!
...
Contributions and feedback are both welcomed and encouraged! [Open an issue](https://github.com/xlango/mqtt-server/issues) to report a bug, ask a question, or make a feature request. If you open a pull request, please try to follow the following guidelines:
...
Are you using Mochi MQTT in a project? [Let us know!](https://github.com/xlango/mqtt-server/issues)
